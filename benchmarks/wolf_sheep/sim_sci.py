...
class Ecosystem():
    ...
    def step(ecosystem, _t):
        ...
        new_sheep_set = jit_set_agents_mask(Animal.remove_agent, num_agents = -1, mask_params = remove_params_sheep, set_params=None, set = new_sheep_set)
        ...
        new_wolf_set = jit_set_agents_mask(Animal.remove_agent, num_agents = -1, mask_params = remove_params_wolf, set_params=None, set = new_wolf_set)
