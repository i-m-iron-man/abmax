...
DAMPING = 0.1
NOISE_SCALE = 0.05
DATA_PATH = "./test/data_s_5/"
#DATA_PATH = "./test/data_s_7/"



# forager params
NUM_FORAGERS = 1 # W&B update
...
# patch params
PATCH_AGENT_TYPE = 2
NUM_PATCH = 400#150 # env lumpiness
...
NUM_GENERATIONS = 4000 # W&B update
...
class Forager(Agent):
    ...
    def create_agent(type, params, id, active_state, key):
        ...
        #random.uniform(subkeys[3], shape=(1,), minval=0.5*energy_begin_max, maxval=energy_begin_max)
